...
const gbSquares = document.querySelectorAll('.gb-square');

console.log(gbSquares)
...
const gameController = (function () {
    ...
    return { startGame, restartGame, checkWin, gameWon, gameTied, updateDisplay };
})();
